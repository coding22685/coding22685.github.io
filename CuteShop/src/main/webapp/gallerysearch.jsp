...
function searchCheck() {
	...
	document.searchfrm.submit();
              ...
              <form name="searchfrm" id="searchfrm" class="" target="ABC" action ="/kjhgallery/selectSearchList.do">
                <input
                  type="text"
                  style="
                    width: 90%;
                ...
                <ul id="galleryul">
	 			...
	 			<li onclick="location.href='/kjhgallery/selectGallery.do?id=${result.id}'">
                    ...
                    <dl>
                      ...
                      <dd id="regdate"><a href="/kjhgallery/selectGallery.do?id=${result.id}">${result.writer} ${result.regdate}</a></dd>
                    </dl>
                  </li>
    ...
    <div class="paging" style="font-size:1.3em;">
  		<ui:pagination paginationInfo="${searchpaginationInfo}" type="image" jsFunction="linkPage"/>
	</div>
...
function linkPage(pageNo){
	location.href = "/kjhgallery/selectSearchList.do?pageNo=" + pageNo + "&searchKeyword=" + ${keyword.searchKeyword } + "&searchCondition=1";
	//pageContext.forward("/kjhgallery/selectSearchList.do?pageNo=" + pageNo + "&searchKeyword=" + ${keyword.searchKeyword } + "&searchCondition=1");
}
</script>
