                  ...
                  <body>
                    ...
                    font-size: 20px;">더착한 고시원</span>
                            ...
                            <div id="gallerycontent" style="margin-left: 20px;">
                              ...
                              <div class="gallerycontentunderdiv" style="font-weight: bold; font-size: 2em">
                                &nbsp;&nbsp;갤러리
                              </div>
                              <br />
                              <script>
                              ...
                              <div class="gallerycontentunderdiv">
                                <hr />
                              </div>
                              ...
                              <div id="galleryhiddendiv">
                                <form name="searchfrm" id="searchfrm" class="" target="ABC"
                                  action="/kjhgallery/KjhgalleryList.do">
                                  <input type="text" style="
                    width: 90%;
                    height: 99.9%;
                    font-size: 15px;
                    border: 1px solid black;
                  " name="searchKeyword" value="${keyword.searchKeyword }" />
                                  <input type="hidden" name="searchCondition" value="1" />
                                  <label onclick="searchCheck();"><i class="fa-solid fa-magnifying-glass"></i></label>
                                </form>
                              </div>
                              <hr />
                              <div id="galleryuldiv">
                                <ul id="galleryul">
                                  <c:forEach var="result" items="${resultList}" varStatus="status">
                                    ...
                                    <li onclick="location.href='/kjhgallery/selectGallery.do?id=${result.id}'">
                                      <a href="/kjhgallery/selectGallery.do?id=${result.id}"><img
                                          src="/${result.appendix}" alt="이미지" />
                                        <dl>
                                          <dt><a
                                              href="/kjhgallery/selectGallery.do?id=${result.id}">${result.subject}</a>
                                          </dt>
                                          <dd id="precontent">
                                            <a href="/kjhgallery/selectGallery.do?id=${result.id}">${result.content}</a>
                                          </dd>
                                          <dd id="regdate"><a
                                              href="/kjhgallery/selectGallery.do?id=${result.id}">${result.writer}
                                              ${result.regdate}</a></dd>
                                        </dl>
                                    </li>
                          ...
                          <div class="footer_content">
                            <div class="foot_nav" style="overflow: auto">
                              <ul>
                                ...
                                <li>
                                  <a
                                    href='javascript:window.open("/privacy.jsp","name", "width=600px,height=380px,left=500px,top=450px");'>개인정보취급방침</a>
                                </li>
                                <li><a href="/estimate.jsp">입실문의</a></li>
                              </ul>
