...
%>
                <div id="posttitle"><%= kjhgalleryVO.getSubject() %></div>
                <div id="postdate"><%= kjhgalleryVO.getRegdate() %>&nbsp;&nbsp;| <%= kjhgalleryVO.getWriter() %> </div>
                <div class="posthrdiv"><hr></div>
                <div id="postcontent">
                  <img src="/<%= kjhgalleryVO.getAppendix() %>" alt="">
                  <p><%= kjhgalleryVO.getContent() %></p>
                </div>
...
<%
if(userVO != null && kjhgalleryVO != null){
	if(userVO.getUserid().equals(kjhgalleryVO.getWriter())){
%>		
