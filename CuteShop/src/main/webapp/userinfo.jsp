        ...
        <div class="main">
          ...
          <div id="centercontentdiv">
            <div id="centerleftmenu">
              <ul>
                <li><a href="/kjhuser/userLogout.do">로그아웃</a></li>
                <li style="background-color: #3176f9">
                  <a href="/userinfo.jsp">정보수정</a>
                </li>
              </ul>
            </div>
            <div id="centercontent">
              ...
              <div style="height: 790px; margin: 15px; width: 80%">
                <form name="memberjoinfrm" id="memberjoinfrm" class="" target="ABC" action ="/kjhuser/updateKjhuser.do">
                  <div
                    style="
                      height: 50px;
                      margin: 15px;
                    ...
                    "
                  >
                    <i class="fa-solid fa-pen"> 비밀번호, 전화번호 변경가능</i>
                  </div>
                  <div
                    style="
                  ...
                  >
                    ...
                    <div style="height: 17%">
                      ...
                      />
                      <input type="hidden" name="id" value="<%=userVO.getId() %>" readonly>
                    </div>
                  </div>
