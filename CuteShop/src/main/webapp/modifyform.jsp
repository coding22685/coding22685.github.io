        ...
        <div class="main">
          ...
          <div id="centercontentdiv">
            ...
            <div id="gallerycontent" style="margin-left: 20px;">
              ...
              <form id="estimateform" name="uploadfrm" target="_self" action="/kjhgallery/modifyKjhgalleryVO.do" method="post" enctype="multipart/form-data">
<% 
KjhgalleryVO kjhgalleryVO = null;
if(session.getAttribute("selectedVO")!=null)
	kjhgalleryVO = (KjhgalleryVO)session.getAttribute("selectedVO");
else
	kjhgalleryVO = new KjhgalleryVO();
%>
                <table id="estimateformtable">
                  <tr>
                    <td>제 목</td>
                    <td><input type="text" id="estimatename" name="subject" value="<%= kjhgalleryVO.getSubject()%>"/></td>
                  </tr>
                  <tr>
                    <td>내 용</td>
                    <td>
                      <textarea
                        ...
                        rows="13%"
                        style="resize: none"
                      ><%= kjhgalleryVO.getContent() %></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>작성자</td>
                    <td><input type="text" id="estimatename" name="writer" value="<%= kjhgalleryVO.getWriter()%>" readonly/></td>
                  </tr>
                  <tr>
                    <td>첨부파일</td>
                    <td><input type="file" id="estimateemail" name="append"/> 기존파일: <%= kjhgalleryVO.getAppendix()%></td>                    
                  </tr>
                  <tr>
                  	<td>기존사진</td>
                  	<td><img src="/<%= kjhgalleryVO.getAppendix() %>" alt="" style="max-width:100%; height:auto;"></td>
                  </tr>
<% 
...
%>                  
                  ...
                  <input type="hidden" name="id" value="<%= kjhgalleryVO.getId()%>">
...
function uploadfrmCheck() {
	...
	{
		document.uploadfrm.action="/kjhgallery/updateKjhgallery.do";
	}
	else
		document.uploadfrm.action="/kjhgallery/modifyKjhgalleryVO.do";
